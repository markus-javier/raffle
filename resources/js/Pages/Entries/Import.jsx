// resources/js/Pages/Entries/Import.jsx
...
export default function EntriesImport({ raffle }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('raffles.entries.import.process', raffle.id), {
            forceFormData: true,
        });
    };
    ...
    const generateCsvTemplate = () => {
        ...
        const header = "name,email,phone,member_id,entries\n";
        const sampleRow = "John Doe,john@example.com,+1234567890,MEM123,1\n";
        ...
        a.href = url;
        a.download = `${raffle.title.replace(/\s+/g, '_')}_template.csv`;
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300 text-sm mb-2">
                                Use CSV import to add multiple participants and entries at once. Your CSV file should have the following columns:
                            </p>
                            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 text-sm mb-4 pl-2">
                                ...
                                <li><span className="font-semibold">email</span> - Email address (optional)</li>
                                ...
                                <li><span className="font-semibold">entries</span> - Number of entries (optional, defaults to 1)</li>
                            </ul>
                            <Button
                ...
                <Card>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            >
                                {processing ? 'Importing...' : 'Import Entries'}
                            </Button>
                        </div>
                    </form>
                </Card>
